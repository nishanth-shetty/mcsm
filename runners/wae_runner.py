...
from losses.wae import wae_kernel, wae_ssm, wae_mcsm, wae_mcsm_backward, wae_mcsm_forward
...
class WAERunner():
    ...
    def test(self):
        ...
        save_image(
            image_grid, f'./assets/generated/{self.config.data.dataset}_{self.config.training.algo}_{self.config.training.method}_dim{self.config.model.z_dim}_image_grid_wae.png')
